...
/**
 * İnteraktif nokta arka planı — imleç yaklaşınca noktalar kabarır/kayar.
 * reactbits.dev DotField'in TS + tabela paletine bağlı hali.
 * Yalnızca landing hero'da kullan: canvas + rAF, içerik-yoğun sayfalarda
 * performans ve okunabilirlik riski taşır.
 */
const DotField = memo(function DotField({
  ...
  useEffect(() => {
    ...
    if (!reduced) {
      ...
      // Hareket azaltma tercihinde: tek kare statik grid çiz, animasyon yok
      tick();
